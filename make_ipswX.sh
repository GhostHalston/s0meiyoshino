...
sudo cp -a ../FirmwareBundles/iPhone5,2_"$IOSVERSION"_"$IOSBUILD".bundle/partition ramdisk/sbin/reboot
sudo cp -a ../FirmwareBundles/iPhone5,2_"$IOSVERSION"_"$IOSBUILD".bundle/ramdiskH.dmg ramdisk/ramdiskH.dmg
